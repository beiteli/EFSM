...
public class Int32NumberToken extends NumberToken
{            
     ...
     */
    public Int32NumberToken(int _value)
    {
        this(_value, (int)0);
    }
     ...
     */
    public Int32NumberToken(int[][] _values)
    {
        this(_values, null);
    }
     ...
     */
    public Int32NumberToken(String _real, String _imaginary)
    {
        super(5, "int32"); 
        sizeX  = 1;
        sizeY  = 1;
     ...
     */
    public Int32NumberToken(int _real, int _imaginary)
    {
        super(5, "int32"); 
        sizeX  = 1;
        sizeY  = 1;
     ...
     * @param _imValues
     */
    public Int32NumberToken(int _dy, int _dx, int[] _reValues, int[] _imValues)
    {
        super(5, "int32"); 
        sizeY  = _dy;
        sizeX  = _dx;
        ...
        if ((_reValues != null)             &&
            ...
            Errors.throwMathLibException("Int32NumberToken: real dimension mismatch");

        if ((_imValues != null)             &&
            (noElem    != _imValues.length)    )
            Errors.throwMathLibException("Int32NumberToken: imag dimension mismatch");
     ...
     * @param _imValues
     */
    public Int32NumberToken(int[] _sizeA, int[] _reValues, int[] _imValues)
    {
        super(5, "int32"); 
        sizeA  = _sizeA;

        if (sizeA.length<2)
            Errors.throwMathLibException("Int32NumberToken: dimension too low <2");
    ...
    {
        return new Int32NumberToken(y, x, new int[y*x],null); 
    }
    ...
    public void setSize(int dy, int dx)
    {
        ...
        if ((dy<sizeY) ||  (dx<sizeX))
            Errors.throwMathLibException("Int32NumberToken: setSize: loosing values");
    ...
    {
        return new Int32NumberToken(values[n][REAL], values[n][IMAG]);
    }
    ...
    {
        values[n][REAL] = ((Int32NumberToken)num).getValueRe();
        values[n][IMAG] = ((Int32NumberToken)num).getValueIm();
    }
