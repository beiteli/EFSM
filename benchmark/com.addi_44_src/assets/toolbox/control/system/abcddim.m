...
function [n, m, p] = abcddim (a, b, c, d)
  ...
  elseif (bn != am)
    warning (["abcddim: a(",num2str(an),"x",num2str(am), " and b(",num2str(bn),"x",num2str(bm),") are not compatible"]);
    return
  endif
  ...
  elseif (cm != an)
    warning (["abcddim: a(",num2str(an),"x",num2str(am), " and c(",num2str(cn),"x",num2str(cm),") are not compatible"]);
    return
  endif
  ...
  if(an > 0)
    ...
    if ( (cn != dn) & have_connections )
      warning (["abcddim: c(",num2str(cn),"x",num2str(cm), " and d(",num2str(dn),"x",num2str(dm),") are not compatible"]);
      return
    endif
