...
function ret = edit (file)
   if (nargin != 1)
      printf("This is a simplified version of edit, you must specify a filepath and only specify a filepath.\n  Ex: edit /sdcard/test.m\n")
   else
      printf("STARTUPADDIEDITWITH=%s\n",file); 
   end
endfunction
