...
public class SunriseSunsetCalculator
{
	 ...
	 *           time zones.
	 */
	public SunriseSunsetCalculator(Location2 location, String timeZoneIdentifier)
	{
	...
	public SolarEventCalculator.moonCoor_ret computeMoon(Calendar date)
	{
		return (calculator.computeMoonStats(date));
	}
