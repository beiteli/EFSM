...
public class LargeStraightMove implements IBaseMove {
	...
	public LargeStraightMove(List<Cube> cubes)
	{
		
	}
	
	public int getPoints() {
		return LargeStraightMove.calculatePoints(null);
	}
	
	public void print() {
		System.out.println("Large Straight, Points: "+getPoints());
	}
}
